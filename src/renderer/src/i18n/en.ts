...
export const en = {
  ...
  settings: {
    ...
    // ---------- NewAPI ----------
    newapiTab: 'Cloud',
    newapiTitle: 'NewAPI Cloud',
    newapiDescription: 'Login to NewAPI platform to use cloud models for PPT generation.',
    newapiUsername: 'Username',
    newapiPassword: 'Password',
    newapiEmail: 'Email (optional)',
    newapiLogin: 'Login',
    newapiRegister: 'Register',
    newapiLoggingIn: 'Logging in...',
    newapiLogout: 'Logout',
    newapiLogoutConfirm: 'Are you sure you want to logout?',
    newapiLoggedIn: 'Logged in',
    newapiNotLoggedIn: 'Not logged in',
    newapiLoginFailed: 'Login failed',
    newapiRegisterFailed: 'Registration failed',
    newapiRegisterSuccess: 'Registration successful, please login',
    newapiFillUsername: 'Enter username',
    newapiFillPassword: 'Enter password',
    newapiAccountInfo: 'Account Info',
    newapiRole: 'Role',
    newapiQuota: 'Quota',
    newapiUsedQuota: 'Used',
    newapiRemainQuota: 'Remaining',
    newapiRequestCount: 'Requests',
    newapiRefreshUser: 'Refresh',
    newapiRefreshing: 'Refreshing...',
    newapiModelSection: 'Model Selection',
    newapiCurrentModel: 'Current Model',
    newapiSelectModel: 'Select model',
    newapiFetchModels: 'Fetch Models',
    newapiFetchingModels: 'Fetching...',
    newapiSetModelSuccess: 'Model switched',
    newapiSetModelFailed: 'Failed to switch model',
    newapiTokenUsage: 'Token Usage',
    newapiTokenName: 'Token Name',
    newapiTokenStatus: 'Status',
    newapiTokenLastAccess: 'Last Access',
    newapiSubscription: 'Subscription',
    newapiPlanName: 'Plan',
    newapiPlanTotal: 'Total Quota',
    newapiPlanUsed: 'Used',
    newapiPlanExpiry: 'Expiry',
    newapiPlanActive: 'Active',
    newapiPlanExpired: 'Expired',
    newapiNoSubscription: 'No subscriptions',
    newapiLogs: 'Call Logs',
    newapiLogsHint: 'Showing call records from the last 3 days',
    newapiLogTokenName: 'Token',
    newapiLogModel: 'Model',
    newapiLogQuota: 'Quota',
    newapiLogPromptTokens: 'Input',
    newapiLogCompletionTokens: 'Output',
    newapiLogDuration: 'Duration',
    newapiLogTime: 'Time',
    newapiLogStream: 'Stream',
    newapiNoLogs: 'No call records',
    newapiFetchLogs: 'Refresh Logs',
    newapiFetchUsage: 'Fetch Usage',
    newapiFetchSubscription: 'Fetch Subscription',
    newapiUnlimited: 'Unlimited',
    newapiRoleAdmin: 'Admin',
    newapiRoleUser: 'User',
    newapiRoleGuest: 'Guest',
    newapiYes: 'Yes',
    newapiNo: 'No',
    newapiDurationUnit: 'ms',
    newapiTokenUnit: 'tokens'
  },
  styles: {
    eyebrow: 'Style Lab',
