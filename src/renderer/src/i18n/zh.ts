export const zh = {
  ...
  settings: {
    ...
    newapiLoggingIn: '登录中...',
    newapiLogout: '退出登录',
    newapiLogoutConfirm: '确定退出登录吗？',
    newapiLoggedIn: '已登录',
    newapiNotLoggedIn: '未登录',
    newapiLoginFailed: '登录失败',
    newapiRegisterFailed: '注册失败',
    newapiRegisterSuccess: '注册成功，请登录',
    newapiFillUsername: '请输入用户名',
    newapiFillPassword: '请输入密码',
    newapiAccountInfo: '账户信息',
    newapiRole: '角色',
    newapiQuota: '额度',
    newapiUsedQuota: '已用额度',
    newapiRemainQuota: '剩余额度',
    newapiRequestCount: '请求次数',
    newapiRefreshUser: '刷新信息',
    newapiRefreshing: '刷新中...',
    newapiModelSection: '模型选择',
    newapiCurrentModel: '当前模型',
    newapiSelectModel: '选择模型',
    newapiFetchModels: '获取模型列表',
    newapiFetchingModels: '获取中...',
    newapiSetModelSuccess: '模型已切换',
    newapiSetModelFailed: '模型切换失败',
    newapiTokenUsage: 'Token 用量',
    newapiTokenName: 'Token 名称',
    newapiTokenStatus: '状态',
    newapiTokenLastAccess: '最后访问',
    newapiSubscription: '订阅套餐',
    newapiPlanName: '套餐',
    newapiPlanTotal: '总额度',
    newapiPlanUsed: '已用额度',
    newapiPlanExpiry: '到期时间',
    newapiPlanActive: '生效中',
    newapiPlanExpired: '已过期',
    newapiNoSubscription: '暂无订阅',
    newapiLogs: '调用日志',
    newapiLogsHint: '显示最近 3 天的调用记录',
    newapiLogTokenName: 'Token',
    newapiLogModel: '模型',
    newapiLogQuota: '额度',
    newapiLogPromptTokens: '输入',
    newapiLogCompletionTokens: '输出',
    newapiLogDuration: '耗时',
    newapiLogTime: '时间',
    newapiLogStream: '流式',
    newapiNoLogs: '暂无调用记录',
    newapiFetchLogs: '刷新日志',
    newapiFetchUsage: '获取用量',
    newapiFetchSubscription: '获取订阅',
    newapiUnlimited: '无限',
    newapiRoleAdmin: '管理员',
    newapiRoleUser: '用户',
    newapiRoleGuest: '访客',
